...
//         case MSYM_POINT_GROUP_TYPE_Kh  : snprintf(name,max,"Kh"); break;
	...
	// Nestor Fri Jul 15 17:28:00 CEST 2016
        case MSYM_POINT_GROUP_TYPE_Ci  : snprintf(name,max,"CI"); break;
        case MSYM_POINT_GROUP_TYPE_Cs  : snprintf(name,max,"CS"); break;
        case MSYM_POINT_GROUP_TYPE_Cn  : if(n==0) snprintf(name,max,"C*"); else snprintf(name,max,"C%d",n) ; break;
        case MSYM_POINT_GROUP_TYPE_Cnh : if(n==0) snprintf(name,max,"C*H"); else snprintf(name,max,"C%dH",n); break;
        case MSYM_POINT_GROUP_TYPE_Cnv : if(n==0) snprintf(name,max,"C*V"); else snprintf(name,max,"C%dV",n); break;
        case MSYM_POINT_GROUP_TYPE_Dn  : if(n==0) snprintf(name,max,"D*"); else snprintf(name,max,"D%d",n); break;
        case MSYM_POINT_GROUP_TYPE_Dnh : if(n==0) snprintf(name,max,"D*H"); else snprintf(name,max,"D%dH",n); break;
        case MSYM_POINT_GROUP_TYPE_Dnd : if(n==0) snprintf(name,max,"D*D"); else snprintf(name,max,"D%dD",n); break;
        case MSYM_POINT_GROUP_TYPE_Sn  : if(n==0) snprintf(name,max,"S*"); else snprintf(name,max,"S%d",n); break;
        case MSYM_POINT_GROUP_TYPE_T   : snprintf(name,max,"T"); break;
        case MSYM_POINT_GROUP_TYPE_Td  : snprintf(name,max,"TD"); break;
        case MSYM_POINT_GROUP_TYPE_Th  : snprintf(name,max,"TH"); break;
        case MSYM_POINT_GROUP_TYPE_O   : snprintf(name,max,"O"); break;
